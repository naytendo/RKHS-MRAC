function [Xi,error,maxP,norm_fs,condNum,condInt,condNew2,V] = greedyCenters(tol,h,OmegaLim,ext,maxN,type,par,scale,interps,targetType,targetNu,targetScale,targetCoefs,Dim,fMag,Scl)
...
V = ur(1:nn,index)';
 ...
 save powerpoints.mat Xi index h
